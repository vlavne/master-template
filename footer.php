    ...
    <div class="container">
        <div class="siteFooterTop">
            <div class="siteFooterTopInfo">
                ...
                <?php if ($footSocial = get_field('footer_socials', 'options')): ?>
                    <?php foreach ($footSocial as $footSo):?>
                    <?php if($footSo['social_link']):?>
                    <a class="" href="<?php echo $footSo['social_link'];?>" rel="nofollow" target="_blank"><img
                            src="<?php echo $footSo['social_icon'];?>" alt=""></a>
            ...
            <div class="siteFooterTopContacts">
                ...
                <div class="siteFooterTopContactsItem siteFooterTopContactsItemAddress"><?php echo $address; ?></div>
                <br>
                <?php endif; ?>
            ...
            <div class="siteFooterTwoTopInfo">
                ...
                <div class="siteFooterTwoTopInfoNews">
                    ...
                    <div class="siteFooterTwoTopInfoNewsForm">
                        ...
                        <input type="email" placeholder="Gerben Sie Ihre E-Mail-Adresse ein"> <a href="#">Folgen<img
                                src="<?php echo get_template_directory_uri(); ?>/img/short_right.svg"
                                alt="short_right"></a>
