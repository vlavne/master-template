<section class="contactPage marg" id="<?php echo get_sub_field('unique_id');?>" data-aos="fade-up"
    ...
    <div class="container contactPageContainer <?php echo get_sub_field('text_position');?>">
        <div class="contactPageContent">
            <?php if ($subtitle = get_sub_field('under_title')): ?>
                <div class="subtitle colorMain" data-aos="fade-up"><?php echo $subtitle; ?></div>
            <?php endif; ?>
            <div class="contactPageText colorMain">
                <?php echo get_sub_field('title');?>
            </div>
            <p class="contactPageTextP colorMain">
