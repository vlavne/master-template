<section class="blackAdvantages blackAdvantagesV2" id="<?php //echo get_sub_field('unique_id');?>" data-aos="fade-up"
    ...
    <div class="containerMax">
        ...
        <<?php echo get_sub_field('title_tag');?> class="blackAdvantagesTitle" data-aos="fade-up"><?php echo $title;?>
